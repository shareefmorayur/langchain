...
class Data extends Collection_1.Collection {
    ...
    insert(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const promise = yield (0, __1.promisify)(this.client, 'Insert', params, timeout);
            return promise;
        });
    }
    /**
    ...
    delete(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const expr = typeof data.ids[0] === 'string'
    ...
    search(data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const idData = ids ? (_e = ids[ids.id_field]) === null || _e === void 0 ? void 0 : _e.data : undefined;
                // add id column
