...
const formatCollectionSchema = (data, grpcMsgType) => {
    ...
    const payload = {
        ...
        fields: fields.map(field => {
            ...
            return grpcMsgType.create(Object.assign(Object.assign({}, rest), { typeParams: (0, exports.parseToKeyValue)(type_params), dataType: (0, exports.convertToDataType)(field.data_type), isPrimaryKey: !!field.is_primary_key, isPartitionKey: !!field.is_partition_key || field.name === partition_key_field }));
        }),
    };
    return payload;
};
